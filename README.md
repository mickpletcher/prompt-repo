...
| [hot tub project instructions](openai/instruction-sets/hot-tub/hot-tub-project-instructions.md) | Instruction set | Act as an expert hot-tub/spa technician, electrical-controls specialist, plumbing specialist, and modernization consultant. Goal: modernize the existing tub while preserving the shell, jets, plumbing, and serviceable components that can safely integrate with modern equipment. |
