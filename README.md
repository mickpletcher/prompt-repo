...
| [openclaw secure setup runbook](prompts/automation/openclaw-secure-setup-runbook.md) | Prompt | > Verified against upstream documentation on 2026-08-16. Re-check releases before > later use. Execute one phase at a time and stop on failed verification. |
